...
public class ReportEpanetDialog extends AbstractOptionsDialog {
	...
	private void initConfig(){
		...
		setTitle(BUNDLE.getString("ReportEpanetDialog.this.title")); 
		setBounds(0, 0, 437, 405);
		getContentPane().setLayout(new MigLayout("", "[90.00][435.00]", "[:292.00:320px][10px][36.00]"));
		
		JPanel panelGeneral = new JPanel();
		panelGeneral.setFont(new Font("Tahoma", Font.BOLD, 14));
		panelGeneral.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), BUNDLE.getString("ReportEpanetDialog.panelGeneral.borderTitle"), TitledBorder.CENTER, TitledBorder.TOP, null, null)); 
		...
		JLabel lblPatternTimestep = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblPatternTimestep.text")); 
		...
		JLabel lblLinks = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblLinks.text")); 
		...
		JLabel lblReportTimestep = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblReportTimestep.text")); 
		...
		JLabel lblPatternStep = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblPatternStep.text")); 
		...
		JLabel lblStartClocktime = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblStartClocktime.text")); 
		...
		JLabel lblReportStart = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblReportStart.text")); 
		...
		JLabel lblNodes = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblNodes.text")); 
		...
		JLabel lblStatistic = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblStatistic.text")); 
		...
		JLabel lblElevation = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblElevation.text")); 
		...
		JLabel lblVelocity = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblVelocity.text")); 
		...
		JLabel lblDemand = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblDemand.text")); 
		...
		JLabel lblHeadloss = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblHeadloss.text")); 
		...
		JLabel lblHead = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblHead.text")); 
		...
		JLabel lblSetting = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblSetting.text")); 
		...
		JLabel lblInfiltration = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblInfiltration.text")); 
		...
		JLabel lblReaction = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblReaction.text")); 
		...
		JLabel lblRuleTimestep = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblRuleTimestep.text")); 
		...
		JLabel lblFFactor = new JLabel(BUNDLE.getString("ReportEpanetDialog.lblFFactor.text")); 
