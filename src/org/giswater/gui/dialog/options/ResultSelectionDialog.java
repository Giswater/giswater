...
public class ResultSelectionDialog extends AbstractOptionsDialog {
	...
	private void initConfig(){
		...
		setTitle(BUNDLE.getString("ResultSelectionDialog.this.title")); 
		setBounds(0, 0, 375, 176);
		getContentPane().setLayout(new MigLayout("", "[90.00][392.00]", "[40px:n][66.00][5px][30.00]"));
		
		String msg = Utils.getBundleString("ResultSelectionDialog.result_selection_message"); 
		...
		panelGeneral.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), BUNDLE.getString("ResultSelectionDialog.panelGeneral.borderTitle"), TitledBorder.CENTER, TitledBorder.TOP, null, null)); 
		...
		JLabel lblStatistic = new JLabel(BUNDLE.getString("ResultSelectionDialog.lblStatistic.text")); 
