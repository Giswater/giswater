...
public class ResultCatEpanetDialog extends AbstractOptionsDialog {
	...
	private void initConfig(){
		...
		setTitle(BUNDLE.getString("ResultCatEpanetDialog.this.title")); 
		setBounds(0, 0, 480, 473);
		getContentPane().setLayout(new MigLayout("", "[90.00][360.00]", "[352.00][5px:n][30]"));	
		
		JPanel panelGeneral = new JPanel();
		panelGeneral.setFont(new Font("Tahoma", Font.BOLD, 14));
		panelGeneral.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), BUNDLE.getString("ResultCatEpanetDialog.panelGeneral.borderTitle"), TitledBorder.CENTER, TitledBorder.TOP, null, null)); 
		...
		JLabel lblFlowUnits = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblFlowUnits.text")); 
		...
		JLabel lblImportDate = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblImportDate.text")); 
		...
		JLabel lblNewLabel_1 = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblNewLabel_1.text")); 
		...
		JLabel lblStartDate = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblStartDate.text")); 
		...
		JLabel lblPatternTimestep = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblPatternTimestep.text")); 
		...
		JLabel lblPatternStep = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblPatternStep.text")); 
		...
		JLabel lblReportTimestep = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblReportTimestep.text")); 
		...
		JLabel lblReportStart = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblReportStart.text")); 
		...
		JLabel lblStartClocktime = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblStartClocktime.text")); 
		...
		JLabel lblStatistic = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblStatistic.text")); 
		...
		JLabel lblFlowRouting = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblFlowRouting.text")); 
		...
		JLabel lblInfiltration = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblInfiltration.text_1")); 
		...
		JLabel lblPondAll = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblPondAll.text")); 
		...
		JLabel lblRuleTimestep = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblRuleTimestep.text")); 
		...
		JLabel lblWaterQ = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblWaterQ.text")); 
		...
		JLabel lblRoutTimestep = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblRoutTimestep.text")); 
		...
		JLabel lblInfilM = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblInfilM.text")); 
		...
		JLabel lblDemMulti = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblDemMulti.text")); 
		...
		JLabel lblHydraAcc = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblHydraAcc.text")); 
		...
		JLabel lblTotalDuration = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblTotalDuration.text")); 
		...
		JLabel lblFlowRouteM = new JLabel(BUNDLE.getString("ResultCatEpanetDialog.lblFlowRouteM.text")); 
		...
		btnDelete.setToolTipText(BUNDLE.getString("ResultCatEpanetDialog.btnDelete.toolTipText")); 
		btnDelete.setActionCommand("delete");
		getContentPane().add(btnDelete, "cell 1 2,alignx right");
		
		btnPrevious = new JButton("<");
		btnPrevious.setToolTipText(BUNDLE.getString("ResultCatEpanetDialog.btnPrevious.toolTipText")); 
		btnPrevious.setActionCommand("movePrevious");
		getContentPane().add(btnPrevious, "flowx,cell 1 2,alignx right");
		
		btnNext = new JButton(">");
		btnNext.setToolTipText(BUNDLE.getString("ResultCatEpanetDialog.btnNext.toolTipText")); 
