...
public class EpaSoftController extends AbstractController {
	...
	public void showSectorSelection() {
        ...
        JDialog dialog = Utils.openDialogForm(panel, view, Utils.getBundleString("EpaSoftController.sector_selection"), 380, 280); 
	...
	public void showControls() {
		...
		if (rs == null) return;		
		ControlsDialog dialog = new ControlsDialog();
		dialog.setTitle(Utils.getBundleString("EpaSoftController.table_controls")); 
		showCatalog(dialog, rs);
	}
