...
ALTER TABLE "doc_x_node" ADD CONSTRAINT "doc_x_node_doc_id_fkey" FOREIGN KEY ("doc_id") REFERENCES "doc" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "doc_x_arc" ADD CONSTRAINT "doc_x_arc_doc_id_fkey" FOREIGN KEY ("doc_id") REFERENCES "doc" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "doc_x_connec" ADD CONSTRAINT "doc_x_connec_doc_id_fkey" FOREIGN KEY ("doc_id") REFERENCES "doc" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "doc_x_gully" ADD CONSTRAINT "doc_x_gully_doc_id_fkey" FOREIGN KEY ("doc_id") REFERENCES "doc" ("id") ON DELETE RESTRICT ON UPDATE CASCADE;
