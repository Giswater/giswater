...
BEGIN
    ...
    -- UPDATE management values
        ...
        IF man_table ='man_greentap' THEN
			...
			expl_id=NEW.expl_id, publish=NEW.publish, inventory=NEW.inventory, end_date=NEW.greentap_end_date, macrodma_id=NEW.macrodma_id
        ...
        ELSIF man_table ='man_wjoin' THEN
			...
			end_date=NEW.wjoin_end_date, macrodma_id=NEW.macrodma_id
			WHERE connec_id=OLD.connec_id;
		...
		ELSIF man_table ='man_tap' THEN
			...
			label_y=NEW.tap_label_y, label_rotation=NEW.tap_label_rotation, expl_id=NEW.expl_id, publish=NEW.publish, inventory=NEW.inventory, end_date=NEW.tap_end_date, macrodma_id=NEW.macrodma_id
			WHERE connec_id=OLD.connec_id;
        ...
        ELSIF man_table ='man_fountain' THEN
			...
			expl_id=NEW.expl_id, publish=NEW.publish, inventory=NEW.inventory, end_date=NEW.fountain_end_date, macrodma_id=NEW.macrodma_id
			WHERE connec_id=OLD.connec_id;
