/*
This file is part of Giswater 2.x
...
ALTER TABLE arc ADD COLUMN flow numeric(12,4); 					-- flow max on conduit, applying manning's equation
ALTER TABLE arc ADD COLUMN drain_parea numeric(12,4);  			-- drain podended area (using parea of subcathcment) of conduit, applying algorithm
...
ALTER TABLE arc ADD COLUMN ofd numeric(12,4);					-- Optimum flow design (Q=CIA/3.6) I=(Id,Tcd) usually=T=10years & Tc=10minuts
ALTER TABLE arc ADD COLUMN oad numeric(12,4);					-- Optimun conduit area design (to support ofd with circular geometry)
...
ALTER TABLE arc ADD COLUMN cf_t2 numeric(12,4);					-- coherent flow on conduit for t=2
ALTER TABLE arc ADD COLUMN cf_t5 numeric(12,4);					-- coherent flow on conduit for t=5
ALTER TABLE arc ADD COLUMN cf_t10 numeric(12,4);				-- coherent flow on conduit for t=10
ALTER TABLE arc ADD COLUMN cf_t20 numeric(12,4);				-- coherent flow on conduit for t=20
